package com.example.foodorderanddeliveryapp.models

import android.os.Parcel
import android.os.Parcelable

data class RestaurantModel (val name: String?, val address:String?,val delivery_charge:String?,val image: String?,val hours:Hours?,var menus: List<Menus?>?) :
    Parcelable {
...
data class Hours(val Sunday: String?,val Monday: String?, val Tuesday: String?,val Wednesday: String?,val Thursday: String?,val Friday: String? ,val Saturday: String?) :
    Parcelable {
    constructor(parcel: Parcel) : this(
        parcel.readString(),
        parcel.readString(),
